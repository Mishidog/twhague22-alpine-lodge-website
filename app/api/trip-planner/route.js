...
const fallbackReply =
  "AI planning is ready to connect once the client adds an OpenAI API key. For now: use Alpine Lodge as your Davis room, start with Blackwater Falls, add Canaan Valley or Timberline based on season, spend an evening in Davis or Thomas, and reserve directly through the Alpine Lodge booking link.";
